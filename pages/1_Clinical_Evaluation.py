...
def load_diagnostic_models():
    # notebook ke mutabik exact sahi model files load ho rahi hain
...
text_pack = {
    ...
    "Hindi": {"title": "व्यक्तिगत स्वास्थ्य मूल्यांकन", "subtitle": "नीचे विवरण दर्ज करें।", "h1": "1. बुनियादी जानकारी", "h2": "2. स्वास्थ्य महत्वपूर्ण", "h3": "परिणाम", "h4": "📋 एहतियाती उपाय", "name": "पूरा नाम", "ref_id": "केस आईडी", "age": "आयु", "weight": "वजन (किग्रा)", "height_ft": "ऊंचाई (फिट)", "height_in": "इंच", "bmi_msg": "गणना की गई बीएमआई", "btn": "मूल्यांकन करें", "db_lbl": "मधुमेह जोखिम", "ht_lbl": "हृदय जोखिम", "ob_lbl": "مमोटापा", "pos": "जोखिम", "neg": "सामान्य"},
    "Punjabi": {"title": "ਨਿੱਜੀ ਸਿਹਤ ਮੁਲਾਂਕਣ ਫਾਰਮ", "subtitle": "ਹੇਠਾਂ ਮੈਟ੍ਰਿਕਸ ਦਰਜ ਕਰੋ।", "h1": "1. ਬੁਨਿਆਦੀ ਜਾਣਕਾਰੀ", "h2": "2. ਸਿਹਤ ਵਾਈਟਲਸ", "h3": "ਨਤੀਜੇ", "h4": "📋 ਸਾਵਧਾਨੀਆਂ", "name": "ਪੂਰਾ ਨਾਮ", "ref_id": "ਕੇਸ ਆਈਡੀ", "age": "ਉਮਰ", "weight": "ਭਾਰ (ਕਿਲੋ)", "height_ft": "ਕੱਦ (ਫੁੱਟ)", "height_in": "ਇੰਚ", "bmi_msg": "BMI ਨਤੀਜਾ", "btn": "ਜਾਂਚ ਸ਼ੁਰੂ ਕਰੋ", "db_lbl": "ਸ਼ੂਗਰ ਦਾ ਖਤਰਾ", "ht_lbl": "ਦਿਲ ਦਾ ਖਤرا", "ob_lbl": "ਮੋਟਾਪਾ", "pos": "ਖਤਰਾ ਹੈ", "neg": "ਨਾਰਮਲ"},
    "Pashto": {"title": "د شخصي روغتیا ارزونې فورمه", "subtitle": "روغتیایی معلومات دننه کړئ.", "h1": "۱. اساسي معلومات", "h2": "۲. روغتیايي نښې", "h3": "پایلې", "h4": "📋 احتیاطي تدابیر", "name": "بشپړ نوم", "ref_id": "کیس ای ډី", "age": "عمر", "weight": "وزن (کلو)", "height_ft": "قامت (فټ)", "height_in": "انچ", "bmi_msg": "حساب شوی BMI", "btn": "ارزونه پیل کړئ", "db_lbl": "د شکرې خطر", "ht_lbl": "د زړه خطر", "ob_lbl": "چاغښت", "pos": "خطر شته", "neg": "نارمل"},
    ...
    "Chinese": {"title": "个人健康 Assessment 表格", "subtitle": "输入健康数据。", "h1": "1. 基本信息", "h2": "2. 生命体征", "h3": "评估结果", "h4": "📋 预防措施", "name": "姓名", "ref_id": "案例 ID", "age": "年龄", "weight": "体重 (kg)", "height_ft": "身高 (英尺)", "height_in": "英寸", "bmi_msg": "计算出的 BMI", "btn": "运行评估", "db_lbl": "糖尿病风险", "ht_lbl": "心脏病风险", "ob_lbl": "肥胖程度", "pos": "阳性", "neg": "正常"},
    ...
    "Bengali": {"title": "ব্যক্তিগত স্বাস্থ্য মূল্যায়ন ফর্ম", "subtitle": "মেট্রিক্স লিখুন।", "h1": "১. সাধারণ তথ্য", "h2": "২. ভাইটালস", "h3": "ফلاফল", "h4": "📋 সতর্কতামূলক ব্যবস্থা", "name": "নাম", "ref_id": "আইডি", "age": "বয়স", "weight": "ওজন (কেজি)", "height_ft": "উচ্চতা (ফুট)", "height_in": "ইঞ্চি", "bmi_msg": "বিএমআই", "btn": "মূল্যায়ন শুরু করুন", "db_lbl": "ডায়াবেটিস ঝুঁকি", "ht_lbl": "হৃদরোগের ঝুঁকি", "ob_lbl": "স্থূলতা", "pos": "ঝুঁকি আছে", "neg": "স্বাভাবিক"},
    ...
    "Japanese": {"title": "健康評価フォーム", "subtitle": "数値を入力してください。", "h1": "1. 基本情報", "h2": "2. バイタル", "h3": "結果", "h4": "📋 予防措置", "name": "氏名", "ref_id": "ケースID", "age": "年齢", "weight": "体重 (kg)", "height_ft": "身長 (feet)", "height_in": "inch", "bmi_msg": "BMI値", "btn": "評価を実行", "db_lbl": "糖尿病リスク", "ht_lbl": "心臓リスク", "ob_lbl": "肥満度", "pos": "リスクあり", "neg": "正常"},
    ...
    "Korean": {"title": "개인 건강 평가 양식", "subtitle": "수치를 입력하세요.", "h1": "1. 기본 정보", "h2": "2. 바이탈", "h3": "결과", "h4": "📋 권장 예방조치", "name": "성명", "ref_id": "케이스 ID", "age": "연령", "weight": "체중 (kg)", "height_ft": "신장 (Feet)", "height_in": "Inches", "bmi_msg": "계산된 BMI", "btn": "평가 실행", "db_lbl": "당뇨 위험", "ht_lbl": "심장 질환 위험", "ob_lbl": "비만도", "pos": "양성", "neg": "정상"},
...
# Dynamic Alignment Setup for Right-to-Left writing styles
...
if st.button(t["btn"]):
    try:
        # EXACT NOTEBOOK FEATURE COLUMN SCHEMAS MATCH AT 100% SPECIFICATION
        # Diabetes Dataframe Vectors
        ...
        # Obesity Dataframe Vectors
        o_input = pd.DataFrame(
            [[float(p_age), float(gender_num), float(bmi_calc)]],
            columns=['Age', 'Gender', 'BMI']
        )

        # Clear active pipeline booster names directly before pushing predictions
        ...
        with res1:
            # Mapping from your training code mapping structure dictionary
            d_map = {0: "Healthy", 1: "Pre-Diabetes", 2: "Diabetes Stage 2"}
            st.metric(label=t["db_lbl"], value=d_map.get(d_res, t["neg"]))
        with res2:
            h_map = {0: "Healthy Heart", 1: "Heart Risk Detected"}
            st.metric(label=t["ht_lbl"], value=h_map.get(h_res, t["neg"]))
        with res3:
            # Notebook mapping structure for target values
            o_map = {0: "Insufficient Weight", 1: "Normal Weight", 2: "Obesity Type I", 3: "Obesity Type II", 4: "Obesity Type III", 5: "Overweight Level I", 6: "Overweight Level II"}
            st.metric(label=t["ob_lbl"], value=o_map.get(o_res, "Normal Weight"))
            
        st.success("Evaluation processed successfully.")
        
        # Dynamic Precaution System Interface
